...
package object base {
  ...
  /**
    ...
    */
  def listbasedOrdering[V](list: Seq[Variable[V]]): Ordering[Variable[V]] = (x: Variable[V], y: Variable[V]) => {
  ...
  /**
    ...
    */
  def lexicographicOrdering[V]: Ordering[Variable[V]] = (x: Variable[V], y: Variable[V]) => x.name.compareTo(y.name)
