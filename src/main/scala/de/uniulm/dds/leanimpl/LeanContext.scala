 ...
 */
private[leanimpl] class LeanContext[V, T](val variableOrder: Comparator[Variable[V]]) extends Context[V, T] {
  ...
  private final val restrictCache: LoadingCache[(LeanDiagram[V, T], Map[Variable[V], V]), LeanDiagram[V, T]] = CacheBuilder.newBuilder.maximumSize(1000000).build(new CacheLoader[(LeanDiagram[V, T], Map[Variable[V], V]), LeanDiagram[V, T]] {
  ...
  private final val applyBinaryOperationCache: LoadingCache[(LeanDiagram[V, T], (T, T) => T, LeanDiagram[V, T]), LeanDiagram[V, T]] = CacheBuilder.newBuilder.maximumSize(1000000).build(new CacheLoader[(LeanDiagram[V, T], (T, T) => T, LeanDiagram[V, T]), LeanDiagram[V, T]] {
  ...
  private final val applyUnaryOperationCache: LoadingCache[(LeanDiagram[V, T], T => T), LeanDiagram[V, T]] = CacheBuilder.newBuilder.maximumSize(1000000).build(new CacheLoader[(LeanDiagram[V, T], T => T), LeanDiagram[V, T]] {
