...
package object leanimpl {
   ...
   */
  def createContext[V, T](variableOrder: Comparator[Variable[V]], restrictCacheSize: Int = 1000000, binaryOpCacheSize: Int = 1000000, unaryOpCacheSize: Int = 1000000): Context[V, T] = new LeanContext[V, T](variableOrder, restrictCacheSize, binaryOpCacheSize, unaryOpCacheSize)
}
